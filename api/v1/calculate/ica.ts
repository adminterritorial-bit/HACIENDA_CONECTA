...
export default async function handler(req:any,res:any){
  ...
  try{
    ...
    const {data,error}=await supabase.rpc("calculate_ica",{p_activities:body.activities||[],p_apply_notices:Boolean(body.applyNoticesAndBoards),p_tax_year:Number(body.taxYear||2026)});
